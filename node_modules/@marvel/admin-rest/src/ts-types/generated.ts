...
export declare type User = {
  ...
  id_kec: Scalars["String"];
  nama_kecamatan: Scalars["String"];
  id_prov: Scalars["String"];
  nama_provinsi: Scalars["String"];
  id_kab: Scalars["String"];
  nama_kabupaten: Scalars["String"];
  id_kel: Scalars["String"];
  nama_kelurahan: Scalars["String"];
...
export declare type ProvinsiPaginator = {
  /** Pagination information about the list of items. */
  paginatorInfo: PaginatorInfo;
  /** A list of Category items. */
  data: Array<typeProvinsi>;
};
...
export declare type typeProvinsi = {
  id_prov?: Scalars["String"];
  nama?: Maybe<Scalars["String"]>;
};

export declare type typeKabupaten = {
  id_kab?: Scalars["String"];
  nama?: Maybe<Scalars["String"]>;
};

export declare type typeKecamatan = {
  id_kec?: Scalars["String"];
  nama?: Maybe<Scalars["String"]>;
};

export declare type typeKelurahan = {
  id_kel?: Scalars["String"];
  nama?: Maybe<Scalars["String"]>;
};


export declare type parentCategories = {
  id?: Scalars["String"];
  name?: Maybe<Scalars["String"]>;
};
